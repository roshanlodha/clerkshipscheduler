...
class Physician:
    def __init__(self, name, speciality, monAM, monPM, tueAM, tuePM, wedAM, wedPM, thuAM, thuPM):
        self.name = name
...
class Student:
    def __init__(self, name, flex_time):
        self.name = name
        self.assignment = {
            "monAM": None,
            "monPM": None,
...
def create_students(students_df):
    ...
    for _, row in students_df.iterrows():
        student = Student(row['name'], row['flex_time'])
